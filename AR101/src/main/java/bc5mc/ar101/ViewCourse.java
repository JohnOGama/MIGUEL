...
public class ViewCourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Programs.setBackground(new java.awt.Color(204, 255, 255));
        ...
        Subjects.setBackground(new java.awt.Color(204, 255, 255));
        Subjects.setForeground(new java.awt.Color(153, 153, 153));
        ...
        SelectedSubject.setBackground(new java.awt.Color(0, 153, 153));
        ...
        SelectedProgram.setBackground(new java.awt.Color(0, 153, 153));
        ...
        BackToHome1.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 12)); // NOI18N
        BackToHome1.setForeground(new java.awt.Color(0, 102, 204));
        BackToHome1.setText("BACK");
        BackToHome1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
